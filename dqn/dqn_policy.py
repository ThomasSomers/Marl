...
class DQNPolicy(Policy):
    ...
    def compute_actions(self,
        ...
        action_batch_t = torch.argmax(q_value_batch_t, 1)
    ...
    def learn_on_batch(self, samples):
        ...
        next_obs_batch_t = torch.tensor(np.array(samples["new_obs"])).to(self.device, non_blocking=True).type(self.dtype_f)
